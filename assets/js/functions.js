...
class strFuncoes {
	...
	//Fun��o para formata��o de string (textos)
	...
	//Fun��o para retirar tra�os entre as palavras
	...
	//Fun��o para trocar letras e acentua��o � � Maiuscula/minuscula
	...
	//Fun��o para retirar preposicoes da string
	...
	public function RetiraPreposicao($palavras){
		...
		$strBase = "a,ante,at�,ap�s,de,desde,em,entre,com,contra,para,por,perante,sem,sob,sobre";
...
public function buscaVetor($palavra, $vetKey) {
   ...
   return null;
	...
	//Fun��o para inserir tra�os entre as palavras	
	...
	//Fun��o para definir como maiuscula a primeira letra da string 
